...
void SpriteSink::FlushBatch(Window& window, const sf::Texture* texture, std::size_t startVertex,
...
void SpriteSink::AppendVertices(const RenderObject& obj)
{
