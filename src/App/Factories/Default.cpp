...
void ApplyCharacterDefinition(entt::registry& r, entt::entity entity, Filepath definition)
{
    ...
    if (components.contains("sprite"))
    {
        ...
        auto atlasID = json::AccessField<AtlasID>(component, "atlas");
        auto region = json::AccessField<String>(component, "region");

        auto zIndex = json::AccessField<zIndex_t>(component, "z-index");
        ...
        auto flipX = json::AccessField<bool>(component, "flip-x");
        auto flipY = json::AccessField<bool>(component, "flip-y");
    ...
    if (components.contains("transform"))
    {
        ...
        auto rotation = json::AccessField<float>(component, "rotation");
